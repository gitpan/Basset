...
$conf->{'Basset::Object::Testing::populate_trickle_parents::Subclass1'}->{'foo'} = 'subclass 1';
$conf->{'Basset::Object::Testing::populate_trickle_parents::Subclass3'}->{'foo'} = 'subclass 3';

package Basset::Object::Testing::populate_trickle_parents::Subclass1;

our @ISA = qw(Basset::Object);

Basset::Object::Testing::populate_trickle_parents::Subclass1->add_trickle_class_attr('foo');

package Basset::Object::Testing::populate_trickle_parents::Subclass2;

our @ISA = qw(Basset::Object::Testing::populate_trickle_parents::Subclass1);

package Basset::Object::Testing::populate_trickle_parents::Subclass3;

our @ISA = qw(Basset::Object::Testing::populate_trickle_parents::Subclass2);

package Basset::Object;

Test::More::ok(! Basset::Object::Testing::populate_trickle_parents::Subclass1->populate_trickle_parents, "Cannot populate parents w/o method");
Test::More::is(Basset::Object::Testing::populate_trickle_parents::Subclass1->errcode, "BO-30", "Proper error code");

Test::More::ok(Basset::Object::Testing::populate_trickle_parents::Subclass3->populate_trickle_parents('foo'), "populated sub 3's parents");

Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass1'}, "subclass1 is populated");

Test::More::is(Basset::Object::Testing::populate_trickle_parents::Subclass1->foo, 'subclass 1', 'proper super attribute');

Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass1'}, "subclass1 populated");
Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass2'}, "subclass2 is populated");
Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass3'}, "subclass3 is populated");
Test::More::is(Basset::Object::Testing::populate_trickle_parents::Subclass3->foo, 'subclass 3', 'proper sub attribute');

Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass2'}, "subclass2 populated");
Test::More::ok(Basset::Object->populated_trickle_parents->{'Basset::Object::Testing::populate_trickle_parents::Subclass3'}, "subclass3 populated");
};
...
Test::More::is(Basset::Object->errcode, 'BO-11', 'proper error code');
